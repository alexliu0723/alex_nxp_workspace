...
C_SRCS += \
../codec/port/cs42448/fsl_codec_cs42448_adapter.c 

C_DEPS += \
./codec/port/cs42448/fsl_codec_cs42448_adapter.d 

OBJS += \
./codec/port/cs42448/fsl_codec_cs42448_adapter.o 


# Each subdirectory must supply rules for building sources it contributes
codec/port/cs42448/%.o: ../codec/port/cs42448/%.c codec/port/cs42448/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-codec-2f-port-2f-cs42448

clean-codec-2f-port-2f-cs42448:
	-$(RM) ./codec/port/cs42448/fsl_codec_cs42448_adapter.d ./codec/port/cs42448/fsl_codec_cs42448_adapter.o

.PHONY: clean-codec-2f-port-2f-cs42448
