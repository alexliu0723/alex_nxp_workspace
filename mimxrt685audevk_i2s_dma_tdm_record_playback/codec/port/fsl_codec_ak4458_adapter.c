 ...
 * Variables
 ******************************************************************************/
static const codec_capability_t s_ak4458_capability = {
...
status_t HAL_CODEC_AK4458_Init(void *handle, void *config)
{
    ...
    ak4458_config_t *devConfig = (ak4458_config_t *)(codecConfig->codecDevConfig);
    ak4458_handle_t *devHandle = (ak4458_handle_t *)((uint32_t)(((codec_handle_t *)handle)->codecDevHandle));

    ((codec_handle_t *)handle)->codecCapability = &s_ak4458_capability;

    /* codec device initialization */
    return AK4458_Init(devHandle, devConfig);
}
...
status_t HAL_CODEC_AK4458_Deinit(void *handle)
{
    ...
    return AK4458_Deinit((ak4458_handle_t *)((uint32_t)(((codec_handle_t *)handle)->codecDevHandle)));
}
...
status_t HAL_CODEC_AK4458_SetFormat(void *handle, uint32_t mclk, uint32_t sampleRate, uint32_t bitWidth)
{
    ...
    return AK4458_ConfigDataFormat((ak4458_handle_t *)((uint32_t)(((codec_handle_t *)handle)->codecDevHandle)), mclk,
                                   sampleRate, bitWidth);
}
...
status_t HAL_CODEC_AK4458_ModuleControl(void *handle, uint32_t cmd, uint32_t data)
{
    ...
    return AK4458_ModuleControl((ak4458_handle_t *)((uint32_t)(((codec_handle_t *)handle)->codecDevHandle)),
                                (ak4458_module_ctrl_cmd_t)cmd, data);
}
