/*
 * fsl_codec_ak4458_adapter.h
 *
 *  Created on: 2023年5月25日
 *      Author: Alex.Liu
 */

#ifndef PORT_FSL_CODEC_AK4458_ADAPTER_H_
#define PORT_FSL_CODEC_AK4458_ADAPTER_H_
#include "fsl_ak4458.h"

/*!
 * @addtogroup ak4458_adapter
...
#define HAL_CODEC_AK4458_HANDLER_SIZE (AK4458_I2C_HANDLER_SIZE + 4)
/*******************************************************************************
 * API
 ******************************************************************************/
 ...
 */
status_t HAL_CODEC_AK4458_Init(void *handle, void *config);
 ...
 */
status_t HAL_CODEC_AK4458_Deinit(void *handle);
 ...
 */
status_t HAL_CODEC_AK4458_SetFormat(void *handle, uint32_t mclk, uint32_t sampleRate, uint32_t bitWidth);
 ...
 * @return kStatus_Success is success, else configure failed.
 */
status_t HAL_CODEC_AK4458_SetVolume(void *handle, uint32_t playChannel, uint32_t volume);
 ...
 * @return kStatus_Success is success, else configure failed.
 */
status_t HAL_CODEC_AK4458_SetMute(void *handle, uint32_t playChannel, bool isMute);
 ...
 * @return kStatus_Success is success, else configure failed.
 */
status_t HAL_CODEC_AK4458_SetPower(void *handle, uint32_t module, bool powerOn);
 ...
 * @return kStatus_Success is success, else configure failed.
 */
status_t HAL_CODEC_AK4458_SetRecord(void *handle, uint32_t recordSource);
 ...
 * @return kStatus_Success is success, else configure failed.
 */
status_t HAL_CODEC_AK4458_SetRecordChannel(void *handle, uint32_t leftRecordChannel, uint32_t rightRecordChannel);
 ...
 * @return kStatus_Success is success, else configure failed.
 */
status_t HAL_CODEC_AK4458_SetPlay(void *handle, uint32_t playSource);
 ...
 * @return kStatus_Success is success, else configure failed.
 */
status_t HAL_CODEC_AK4458_ModuleControl(void *handle, uint32_t cmd, uint32_t data);
...
{
    return HAL_CODEC_AK4458_Init(handle, config);
}
...
{
    return HAL_CODEC_AK4458_Deinit(handle);
}
...
{
    return HAL_CODEC_AK4458_SetFormat(handle, mclk, sampleRate, bitWidth);
}
...
{
    return HAL_CODEC_AK4458_SetVolume(handle, playChannel, volume);
}
...
{
    return HAL_CODEC_AK4458_SetMute(handle, playChannel, isMute);
}
...
{
    return HAL_CODEC_AK4458_SetPower(handle, module, powerOn);
}
...
{
    return HAL_CODEC_AK4458_SetRecord(handle, recordSource);
}
...
{
    return HAL_CODEC_AK4458_SetRecordChannel(handle, leftRecordChannel, rightRecordChannel);
}
...
{
    return HAL_CODEC_AK4458_SetPlay(handle, playSource);
}
...
{
    return HAL_CODEC_AK4458_ModuleControl(handle, cmd, data);
}
#endif
...
/*! @} */
#endif /* PORT_FSL_CODEC_AK4458_ADAPTER_H_ */
